...
<style id="preview-force-no-auth">#connectModal{display:none!important}</style>
</head><body>
<script src="./preview-demo-api.js?v=20260922-3"></script>
...
<script src="./preview-bootstrap-v2.js?v=20260922-3"></script>
</body>
</html>
